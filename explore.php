<?php
    ...
    class Explore {
        ...
        Static Public function getSearchResults($query) {
            $query = str_replace(" ", '%20', $query);
    
            $url = "https://moviesloop.herokuapp.com/api.php?search=$query";
        ...
        Static Public function renderMovies($res) {
            $movies = $res['movies'];
    
            echo '<div class="movies-container primary-movies-container">';
            ...
            foreach($movies as $movie){
                ...
                <div class="movie">
                    <a href="./movie/'.str_replace(" ", "-", $title).'"></a>
    ...
    $res = Explore::getSearchResults($query);
...
<html lang="en">
  <head>
    ...
    <title>Moviesloop | Explore</title>
    ...
    <header>
      <section class="left-section">
        <button
          ...
          onclick="toggleNav()"
        ></button>
        <a class="logo_link" href="https://moviesloop.herokuapp.com/">
          <img
            class="logo"
    ...
    <main class="nav-opened isMobile">
      ...
      <article>
        <section class="movies-section">
            <h1>
                <?php
                    if(strlen($query) < 1) echo "Results for: anything";
                    else echo "Results for: ".$query; 
                ?>
            </h1>
            <?php
            if($error == 1){
                echo '<h2 class="error-msg">No results!</h2>';
            }else{
                Explore::renderMovies($res);
            }
            ?>
        </section>
      </article>
